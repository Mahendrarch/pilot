...
function createAudioOscillator(audioContext, masterGain, frequency = 440, type = 'sine', duration = 0.1) {
...
function playWeaveSound(audioContext, masterGain, velocity) {
...
function playTransitionSound(audioContext, masterGain) {
  if (!audioContext || !masterGain) return;
...
const SECTIONS$1 = ["landing", "about", "skills", "projects", "contact"];
function WeaveCanvas({
  ...
  const weavePatternRef = reactExports.useRef(null);
  const brandKnotRef = reactExports.useRef(null);
  const [dimensions, setDimensions] = reactExports.useState({ width: 0, height: 0 });
  const lastTimeRef = reactExports.useRef(performance.now());
  const animationFrameRef = reactExports.useRef(null);
  const [isInitialized, setIsInitialized] = reactExports.useState(false);
  const [hoveredSkill, setHoveredSkill] = reactExports.useState(null);
  const [hoveredProject, setHoveredProject] = reactExports.useState(null);
  ...
  const drawLanding = reactExports.useCallback((ctx, time) => {
  ...
  const drawAbout = reactExports.useCallback((ctx) => {
    const centerX = dimensions.width / 2;
  ...
  const drawSkills = reactExports.useCallback((ctx) => {
  ...
  const drawProjects = reactExports.useCallback((ctx) => {
    dimensions.height;
  ...
  const drawContact = reactExports.useCallback((ctx) => {
    const centerX = dimensions.width / 2;
    ctx.font = "600 36px Cormorant Garamond";
    ctx.fillStyle = brandColors.text;
    ctx.textAlign = "center";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "canvas",
    {
      ...
      style: {
        ...
        left: 0,
        width: "100%",
        height: `${SECTIONS$1.length * 100}vh`,
        display: "block",
        cursor: "crosshair"
      },
...
function Controls({ isMuted, onToggleMute, reducedMotion, onToggleReducedMotion, highContrast, onToggleHighContrast }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "12px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "14px", fontWeight: "500" }, children: "Audio" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
                  fontSize: "12px",
                  color: isMuted ? "#94a3b8" : "#6366f1",
                  textTransform: "uppercase"
                }, children: isMuted ? "Off" : "On" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "12px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "14px", fontWeight: "500" }, children: "Reduced Motion" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
                  fontSize: "12px",
                  color: reducedMotion ? "#6366f1" : "#94a3b8",
                  textTransform: "uppercase"
                }, children: reducedMotion ? "On" : "Off" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "14px", fontWeight: "500" }, children: "High Contrast" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
                  fontSize: "12px",
                  color: highContrast ? "#6366f1" : "#94a3b8",
                  textTransform: "uppercase"
                }, children: highContrast ? "On" : "Off" })
              ]
            }
          ) })
        ]
...
function SectionIndicator({ currentSection, totalSections, onNavigate }) {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    height: "8px",
                    borderRadius: "2px",
                    background: isActive ? brandColors.primary : isVisited ? `${brandColors.primary}60` : `${brandColors.muted}40`,
                    transition: "all 0.3s ease",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    ...
                    color: isActive ? brandColors.text : isVisited ? brandColors.muted : `${brandColors.muted}60`,
                    textTransform: "uppercase",
                    letterSpacing: "1px",
...
function ContactForm({ audioContext, masterGain }) {
    ...
    "form",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
          ...
          errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "name-error", style: {
            fontSize: "12px",
            color: "#ef4444",
            marginTop: "4px",
            margin: 0
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
          ...
          errors.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "email-error", style: {
            fontSize: "12px",
            color: "#ef4444",
            marginTop: "4px",
            margin: 0
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
          ...
          errors.message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "message-error", style: {
            fontSize: "12px",
            color: "#ef4444",
            marginTop: "4px",
            margin: 0
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              width: "100%",
              padding: "14px",
              background: status === "submitting" ? `${brandColors.primary}80` : status === "success" ? "#10b981" : status === "error" ? "#ef4444" : brandColors.primary,
              color: "#fff",
              border: "none",
              borderRadius: "8px",
              fontSize: "14px",
            ...
            children: status === "submitting" ? "Weaving..." : status === "success" ? "Message Sent!" : status === "error" ? "Try Again" : "Send Message"
          }
        ),
        status === "success" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Your thread has been woven into the tapestry. I'll respond soon!"
          }
        )
      ]
    }
...
function useMousePosition() {
  ...
  const [velocity, setVelocity] = reactExports.useState({ x: 0, y: 0 });
  const lastPosition = reactExports.useRef({ x: 0, y: 0 });
  const lastTime = reactExports.useRef(Date.now());
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "main",
    {
      ...
      children: [
        ...
        currentSection === 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(ContactForm, { audioContext, masterGain }),
        !hasInteracted && !reducedMotion && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
              ...
              color: "#e2e8f0",
              fontWeight: "500"
            }, children: "Click anywhere to enable audio ✦" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "aria-live": "polite",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Mahendrarch - Creative Technical Craftsman" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { "aria-label": "Main navigation", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: SECTIONS.map((section, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `#section-${index}`, children: [
                section.charAt(0).toUpperCase() + section.slice(1),
                currentSection === index ? " (current)" : ""
              ] }) }, section)) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Navigate by scrolling or using the section indicators on the left." })
            ]
          }
        ),
